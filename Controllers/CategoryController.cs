...
namespace FigureShop.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public CategoryController(FigureShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,CreatedAt,UpdatedAt")] Category category)
        {
